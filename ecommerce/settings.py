...
USE_I18N = config('USE_I18N', default=True, cast=bool) #Trueue

USE_TZ = config('USE_TZ', default=True, cast=bool) #True
...
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD')  # Use app-specific password
